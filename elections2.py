...
#session = ftplib.FTP('ftp.stuartathompson.com','stuartat','cl0U*M5sy')
#session.cwd('public_html/globedev/base/byelection-assets/')

#connect to FTP
session = ftplib.FTP('cheppo1.front.theglobeandmail.com','YYYYYYY','XXXXXXX')
